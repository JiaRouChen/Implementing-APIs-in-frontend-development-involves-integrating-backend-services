...
namespace MyWebAPI.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Department>>> GetDepartment()
        {
            ...
            //var result = from d in _context.Department
            //             select new { 
            //                 d.DeptID, 
            //                 d.DeptName 
            //             };

            //var result = _context.Department.Select(d => new DepartmentDTO
            // {
            //    DeptID= d.DeptID,
            //    DeptName= d.DeptName
            //});
        ...
        public async Task<ActionResult<DepartmentDTO>> GetDepartment(string id)
        {
            ...
            var department = await _context.Department.Select(d => new DepartmentDTO
            {
                DeptID = d.DeptID,
                DeptName = d.DeptName
            }).Where(d => d.DeptID == id).SingleOrDefaultAsync();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDepartment(string id, [FromForm]Department department)
        {
